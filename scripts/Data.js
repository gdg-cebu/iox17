var Data = {
	speaker: {
		...
		"jordan-deja": {
			name: "Jordan Deja",
			title: "",
			bio: "Jordan is currently a university and senior high school professor, teaching courses in innovation, design thinking and human computer interaction. He is group head of the Seamless Interfaces Division of the Center for Complexity and Emerging Technologies, the College of Computer Studies in De La Salle University in Manila. He is also co founder of PhiChi (Philippines Computer Human Interaction Group), an ACM Special Interest Group in Computer Human Interaction (SIGCHI). Jordan hails with BS and MS degrees in Computer Science from De La Salle University. He is currently preparing for his doctoral studies working with sensors and machine learning.",
			sm: {
				gp: "",
				fb: "",
				tw: ""
		...
		"juvar-abrera": {
			name: "Juvar Abrera",
			title: "Creatives Head, Google Developer Group Philippines",
			bio: "Juvar is a fresh graduate of BS Information Technology from De La Salle University - Dasmariñas. He specializes in web design and development specifically PHP for the backend. He loves to develop complex web application systems, and design neat, simple, and minimalistic websites where some are based in Google Material Design. He is also the Creatives Head of Google Developers Group Philippines.",
			sm: {
